---
title: Netty应用
date: 2022-10-30T13:28:44Z
lastmod: 2023-03-27T19:48:41Z
---
...
　　![image.png](assets/net-img-1665073234010-c17ae82e-6da7-479a-ba1c-b1543abba0d5-20221111215525-80jshsc.png)

　　写模式下，position 是写入位置，limit 等于容量，下图表示写入了 4 个字节后的状态

　　![image.png](assets/net-img-1665073347225-5388dfc6-3fc2-4492-902c-b7fcd02f3245-20221111215525-4h0vo0n.png)

　　flip 动作发生后，position 切换为读取位置，limit 切换为读取限制

　　![image.png](assets/net-img-1665073353104-76e6707d-af7c-4e84-97dd-7458adee7994-20221111215525-0zkzrc2.png)

　　读取 4 个字节后，状态

　　![image.png](assets/net-img-1665073358729-865ac7d0-89b5-4cc8-814e-a892038da58b-20221111215525-k257bcx.png)

　　clear 动作发生后，状态

　　![image.png](assets/net-img-1665073365265-002fd960-3cab-45d5-a547-968487191335-20221111215525-51j8yv0.png)

　　compact 方法，是把未读完的部分向前压缩，然后切换至写模式

　　![image.png](assets/net-img-1665073370943-3b2e7f1c-7c9a-46a3-9e37-31742edea2f4-20221111215525-xb7w2cn.png)
...
　　![image.png](assets/net-img-1665073313636-93fb8cb7-e679-4c0f-8067-885d28f67ded-20221111215526-vcl9xfw.png)
...
　　![image.png](assets/net-img-1665073398713-d6f47c91-e7a2-407a-9cc0-de52b301cf26-20221111215526-gwi38jk.png)

- 阻塞 IO
  ![image.png](assets/net-img-1665073405592-73518a43-9c02-4d55-baee-bafcff044efe-20221111215526-c9mhwt8.png)
- 非阻塞  IO
  ![image.png](assets/net-img-1665073414310-928255a5-b8a0-4a7b-817f-dbabda18feef-20221111215526-c0gy94f.png)
- 多路复用
  ![image.png](assets/net-img-1665073424520-10dfe592-ea00-4ea5-b46e-992601919f1f-20221111215526-q1f6my9.png)
- 信号驱动
- 异步 IO
  ![image.png](assets/net-img-1665073433573-ed1fdba5-d19f-40c2-a4f9-96a6ddbff0d2-20221111215526-5pgyp70.png)
- 阻塞 IO vs 多路复用
  ![image.png](assets/net-img-1665073440336-5f261660-b58b-4c06-9c1d-f21c0865e31c-20221111215526-0s6pvi9.png)
  ![image.png](assets/net-img-1665073448391-a1d5eef7-134c-4b01-9c2e-2df8cc9ec893-20221111215526-gp8xqtg.png)
...
　　![image.png](assets/net-img-1665073460709-ab3783c9-f4f3-46ae-ab45-fe489a701313-20221111215526-4cnfbe6.png)
...
　　![image.png](assets/net-img-1665073467540-2062cc90-042f-4ea8-8dbc-1afa0c8232c7-20221111215527-13hnynb.png)
...
　　![image.png](assets/net-img-1665073473485-b4b83d79-2af4-4681-9d50-1c9096dc935c-20221111215527-zawp2eq.png)
...
　　![image.png](assets/net-img-1665073484287-631d0da3-1bb4-4881-b567-647d058f4f47-20221111215527-l67jrtu.png)
...
1. 目前存在的线程模型有：传动阻塞`I/O`​服务模型和`Reactor`​模型
2. 根据`Reactor`​的数量和处理资料线程的数量不同，有三种经典实现

    1. 单`Reactor`​单线程
    2. 单`Reactor`​多线程
    3. 主从`Reactor`​多线程
3. Netty线程模型（Netty主要基于主从`Reactor`​多线程模型做了一定改进，有多​`Reactor`​）
...
　　​![](assets/net-img-0002-20230327194009-43b76u4.png)​

## 3. `Reactor`​​模式

　　​![](assets/net-img-0004-20230327194009-xusl7vj.png)​
...
　　​![](assets/net-img-0005-20230327194009-2m11zb7.png)​
...
　　​![](assets/net-img-0006-20230327194009-rdpidiy.png)​
...
　　​![](assets/net-img-0007-20230327194009-obwi5jv.png)​

　　​![](assets/net-img-0008-20230327194010-vj80p08.jpg)​
...
　　​![](assets/net-img-0009-20230327193706-lo1au43.jpg)​
...
　　​![](assets/net-img-0010-20230327194235-781jk47.png)​
...
　　​![](assets/net-img-0011-20230327194235-6us5fo3.png)​

　　​`BossGroup`​有点像主`Reactor`​ 可以有多个，`WorkerGroup`​则像`SubReactor`​一样可以有多个。

### 工作原理示意图3 - 详细版

　　​![](assets/net-img-0012-20230327194235-dpf6how.png)​
...
- 2 处，选择服务 Scoket 实现类，其中 NioServerSocketChannel 表示基于 NIO 的服务器端实现，其它实现还有
  ![image.png](assets/net-img-1665073576092-3eea97da-b483-4acc-a6fd-eece98224cd0-20221111215527-fr7igf9.png)
...
- 2 处，选择客户 Socket 实现类，NioSocketChannel 表示基于 NIO 的客户端实现，其它实现还有
  ![image.png](assets/net-img-1665073567805-1c681335-41e9-40c3-a02a-0155e0383924-20221111215527-s7tudvn.png)
...
　　![image.png](assets/net-img-1665073584346-6bc72f6a-0e4a-412e-94bc-81d860d5b059-20221111215527-k046iu2.png)
...
　　![image.png](assets/net-img-1665073596487-2a45c98e-71a7-45e8-a0c2-ac4b06cd0cff-20221111215527-fzwff39.png)
...
　　![image.png](assets/net-img-1665073607553-c63d8f6f-883c-4ce4-9acd-3861c0ffd7ff-20221111215527-e9urwmu.png)
...
　　![image.png](assets/net-img-1665073624592-674dd74d-86d2-4605-9955-7a16e09a1cb4-20221111215527-1blmix8.png)

　　经研究发现，看病可以细分为四个步骤，经拆分后每个步骤需要 5 分钟，如下

　　![image.png](assets/net-img-1665073630217-bd1f44be-c442-48c7-9478-62d7f8fc79ce-20221111215527-fmqia49.png)

　　因此可以做如下优化，只有一开始，医生 2、3、4 分别要等待 5、10、15 分钟才能执行工作，但只要后续病人源源不断地来，他们就能够满负荷工作，并且处理病人的能力提高到了 `4 * 8 * 12` 效率几乎是原来的四倍

　　![image.png](assets/net-img-1665073635044-265417f7-ec52-4a11-9a17-929aa008498c-20221111215527-s30ehyk.png)
...
　　![image.png](assets/net-img-1665073657734-f1c3e079-3804-43d3-8e30-9b46530ad337-20221111215527-74wm25r.png)
...
　　![image.png](assets/net-img-1665073663657-eac74193-3f2d-4823-b1ce-076ee644f1ba-20221111215527-ce3yoc2.png)

#### ChannelHandler的生命周期

　　建立连接 ChannelHandler 回调方法的执行顺序  
**handlerAdded --&gt; channelRegistered --&gt; channelActive --&gt; channelRead --&gt; channelReadComplete**

1. handlerAdded() : 指当检测到连接新连接后，调用ch.pipeline().addList(new Handler);之后的回调，表示在当前的channel中，已经添加了一个handler
2. channelRegistered() : 这个回调表示当前的channel的所有逻辑处理已经和某个NIO线程建立了绑定关系
3. channelActive() : 这个回调表示当前channel所有的业务逻辑链已经准备完毕（channel和pipline已经添加了所有处理hanndler）以及绑定了一个NIO线程
4. channelRead() : 客户端向服务端发来数据，每次都会回调该方法，表示有数据可读
5. channelReadComplete() : 服务端每次读完一次完成的数据之后，回调该方法，表示数据读取完毕。

　　断开连接 ChannelHandler  回调方法的执行顺序

　　**channelInactive --&gt; channelUnregistered --&gt; handlerRemoved**

1. channelInactive() : 表示该链接已经被关闭了，这条连接在TCP层面已经不在是通讯状态啦
2. channelUnregistered() : 这个回调表示与这条连接对应的NIO线程移除了对这条连接的处理
3. handlerRemoved() : 把这条连接上的所有业务逻辑处理移除

　　​![微信图片_20221129215049](assets/微信图片_20221129215049-20221129215137-xy69pf5.jpg)​
...
* byteBufFormat： 传输字节打印形式 默认以16进制打印
...
##### ByteToMessageCodec 编解码器 

> 继承该类对信息进行编码和解码

```java
/**
 * 相当于MessageToByteEncoder<Object>  和 ByteToMessageDecoder 组合
 */
public class PackCodec extends ByteToMessageCodec<Object> {
...
##### SimpleChannelInboundHandler<T>  对象处理

```java
public class DataHandler extends SimpleChannelInboundHandler<Object> {
...
　　**💡SimpleChannelInboundHandler** 默认处理完毕后会将资源释放，需要手动释放资源可继承**ChannelInboundHandlerAdapter**
...
　　![image.png](assets/net-img-1665073671982-4bc2b9c6-228b-49a6-96ed-ab6555a1b26d-20221111215527-af0xz7y.png)
...
　　![image.png](assets/net-img-1665073689906-f5db7615-5190-4e77-9d08-d177ad4026de-20221111215533-4736rjm.png)
...
　　![image.png](assets/net-img-1665073701183-299298fc-39d3-49a7-80e3-7c1240dbf6bc-20221111215533-jaec6x0.png)
...
>   ![image.png](assets/net-img-1665073728272-8bc0096c-6425-4310-979a-28ad42d6e2c0-20221111215533-kvytuuy.png)
> - 为了解决此问题，引入了窗口概念，窗口大小即决定了无需等待应答而可以继续发送的数据最大值
>   ![image.png](assets/net-img-1665073733517-eb68002c-afc1-4746-96e4-0fa95b21bfad-20221111215533-jinki2i.png)
...
　　   ![image.png](assets/net-img-1665073741703-3acb8484-f36b-4738-8769-c50625b23727-20221111215534-pwccic8.png)
...
　　![image.png](assets/net-img-1665073776507-524d18b7-c84e-4311-a742-c02a67d7a63e-20221111215534-h1bzg7o.png)

#### 💡 什么时候可以加 [@Sharable ](/Sharable )

- 当 handler 不保存状态时，就可以安全地在多线程下被共享
- 但要注意对于编解码器类，不能继承 ByteToMessageCodec 或 CombinedChannelDuplexHandler 父类，他们的构造方法对 [@Sharable ](/Sharable ) 有限制
...
　　![](img/0032.png#crop=0&crop=0&crop=1&crop=1&id=z1Omt&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=)
